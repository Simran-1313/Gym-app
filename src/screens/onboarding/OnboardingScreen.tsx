...
import { submitProfile } from '../../services/member.service';
      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>We'll use this to build your personalised diet plan.</Text>
            <FormProgress progress={completion} />
            <Text style={styles.progressLabel}>{Math.round(completion * 100)}% complete</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  subtitle: { ...TYPOGRAPHY.body, color: COLORS.textSecondary, textAlign: 'center', marginTop: SPACING.xs, lineHeight: 20 },
  progressTrack: {
    width: '100%',
    height: 6,
  ...
  progressLabel: { color: COLORS.textMuted, fontSize: FONT_SIZE.xs, marginTop: SPACING.xs },
  section: { gap: SPACING.md },
  sectionTitle: { ...TYPOGRAPHY.heading, color: COLORS.text },
  fieldLabel: { color: COLORS.textSecondary, fontSize: FONT_SIZE.sm, fontWeight: '500', marginTop: SPACING.xs },
